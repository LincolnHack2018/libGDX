...
public class Filters {
    ...
    public static final short MASK_PUCK = BOX2D_FILTER_PADDLE | BOX2D_FILTER_IMPENETRABLE_BARRIER; // or ~CATEGORY_PLAYER
    public static final short MASK_PADDLE = BOX2D_FILTER_PUCK | BOX2D_FILTER_PLAYER_PENETRABLE_BARRIER | BOX2D_FILTER_IMPENETRABLE_BARRIER; // or ~CATEGORY_MONSTER
